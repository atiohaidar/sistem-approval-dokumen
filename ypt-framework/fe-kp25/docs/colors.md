...
## Next steps (opsional)
- Buat `src/styles/colors.ts` yang mengekspor palet warna untuk dipakai di komponen Vue/JS.
- Tambah contoh usage di Storybook atau komponen dokumentasi.

---
Dokumen dibuat otomatis. Jika mau, saya bisa juga menambahkan file TypeScript export untuk palet atau menyesuaikan rekomendasi pada file SCSS agar tidak perlu `!important`.